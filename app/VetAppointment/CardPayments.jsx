...
const CardPayments = () => {
  return (
    <SafeAreaView>
      ...
      <View style={[styles.frameContainer1, styles.frameShadowBox]}>
        <View style={[styles.paytmWrapper, styles.wrapperFlexBox]}>
          <Text style={[styles.paytm, styles.paytmTypo]}>Master Card</Text>
        </View>
        <Image
          style={[styles.instanceChild, styles.instanceChildLayout]}
          contentFit="cover"
        ...
        />
        <Image
          style={[styles.instanceChild, styles.instanceChildLayout1]}
          contentFit="cover"
          source={require("../../assets/fonts/Ellipse 48.png")}
        />
        <Image
          style={styles.icbaselineAppleIcon}
          contentFit="cover"
